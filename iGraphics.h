...
void iHalfCircle(double x, double y, double r, int slices=100)
{
	double t, PI=acosl(-1), dt, x1,y1, xp, yp;
	dt = 2*PI/slices;
	xp = x+r;
...
void iOneFourthUpperEllipse(double x, double y, double a, double b, int slices=100)
{
	double t, PI=acosl(-1), dt, x1,y1, xp, yp;
	dt = 2*PI/slices;
	xp = x+a;
...
void iOneFourthDownEllipse(double x, double y, double a, double b, int slices=100)
{
	double t, PI=acosl(-1), dt, x1,y1, xp, yp;
	dt = 2*PI/slices;
	xp = x+a;
...
void iHalfEllipse(double x, double y, double a, double b, int slices=100)
{
	double t, PI=acosl(-1), dt, x1,y1, xp, yp;
	dt = 2*PI/slices;
	xp = x+a;
